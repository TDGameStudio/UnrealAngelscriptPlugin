...
{
private:
static FString MakeAutomationDocsSuffix()
{
	return FGuid::NewGuid().ToString(EGuidFormats::Digits).Left(12);
}

static FString MakeDocsScriptSource(const FString& TypeName)
{
...
static asITypeInfo* FindTypeInfoByDecl(
...
static bool LoadGeneratedDocsFile(
	FAutomationTestBase& Test,
...
FAngelscriptEngine& Engine = ASTEST_CREATE_ENGINE_FULL();
		...
		const FString DocsScriptFilename = FString::Printf(TEXT("Docs/%s.as"), *TypeName);
