	...
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
{
	...
	TEST_METHOD(Construction)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_Ctor"), ASTEST_AS(R"AS(
			int Ctor_EmptyLen()
			{
				FString S;
				return S.Len();
	...
	TEST_METHOD(Operators)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_Operators"), ASTEST_AS(R"AS(
			// ---- opEquals ----
			int OpEq_Same()
			{
				return ("ABC" == "ABC") ? 1 : 0;
	...
	TEST_METHOD(OperatorIndexError)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_IndexErr"), ASTEST_AS(R"AS(
	...
	TEST_METHOD(LengthAndCapacity)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_LenCap"), ASTEST_AS(R"AS(
			int Len_Empty()
			{
				FString S;
				return S.Len();
			...
			int IsEmpty_NonEmpty()
			{
				FString S = "X";
				return S.IsEmpty() ? 1 : 0;
			}

			int IsEmpty_AfterEmpty()
			{
				FString S = "X";
				S.Empty();
				return S.IsEmpty() ? 1 : 0;
	...
	TEST_METHOD(Substring)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_Substr"), ASTEST_AS(R"AS(
			// ---- Left / LeftChop ----
			int Left_Full()
			{
				FString S = "ABCDE";
				return (S.Left(5) == "ABCDE") ? 1 : 0;
			}

			int Left_Partial()
			{
				FString S = "ABCDE";
				return (S.Left(3) == "ABC") ? 1 : 0;
			}

			int Left_Zero()
			{
				FString S = "ABCDE";
				return S.Left(0).IsEmpty() ? 1 : 0;
			}

			int Left_OverLength()
			{
				FString S = "AB";
				return (S.Left(10) == "AB") ? 1 : 0;
			}

			int LeftChop_Basic()
			{
				FString S = "ABCDE";
				return (S.LeftChop(2) == "ABC") ? 1 : 0;
			}

			int LeftChop_All()
			{
				FString S = "AB";
				return S.LeftChop(2).IsEmpty() ? 1 : 0;
			}
			...
			{
				FString S = "ABCDE";
				return (S.Right(3) == "CDE") ? 1 : 0;
			}

			int Right_Full()
			{
				FString S = "ABCDE";
				return (S.Right(5) == "ABCDE") ? 1 : 0;
			}

			int Right_Zero()
			{
				FString S = "ABCDE";
				return S.Right(0).IsEmpty() ? 1 : 0;
			}

			int RightChop_Basic()
			{
				FString S = "ABCDE";
				return (S.RightChop(2) == "CDE") ? 1 : 0;
			}

			int RightChop_All()
			{
				FString S = "AB";
				return S.RightChop(2).IsEmpty() ? 1 : 0;
			}
			...
			{
				FString S = "ABCDE";
				return (S.Mid(1, 3) == "BCD") ? 1 : 0;
			}

			int Mid_ToEnd()
			{
				FString S = "ABCDE";
				return (S.Mid(3) == "DE") ? 1 : 0;
			}

			int Mid_Start()
			{
				FString S = "ABCDE";
				return (S.Mid(0, 2) == "AB") ? 1 : 0;
			}

			int Mid_Single()
			{
				FString S = "ABCDE";
				return (S.Mid(2, 1) == "C") ? 1 : 0;
			}
	...
	TEST_METHOD(Search)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_Search"), ASTEST_AS(R"AS(
			// ---- Contains ----
			int Contains_Found()
			{
				FString S = "Hello World";
				return S.Contains("World") ? 1 : 0;
			}

			int Contains_NotFound()
			{
				FString S = "Hello World";
				return S.Contains("xyz") ? 1 : 0;
			}

			int Contains_CaseSensitive()
			{
				FString S = "Hello";
				return S.Contains("hello", ESearchCase::CaseSensitive) ? 1 : 0;
			}

			int Contains_IgnoreCase()
			{
				FString S = "Hello";
				return S.Contains("hello", ESearchCase::IgnoreCase) ? 1 : 0;
			}

			int Contains_Partial()
			{
				FString S = "Hello World";
				return S.Contains("lo Wo") ? 1 : 0;
			}

			int Contains_InEmpty()
			{
				FString S;
			...
			int Find_CaseSensitive()
			{
				FString S = "ABCabc";
				return S.Find("abc", ESearchCase::CaseSensitive);
			}

			int Find_IgnoreCase()
			{
				FString S = "ABCabc";
				return S.Find("abc", ESearchCase::IgnoreCase);
			}
			...
			// ---- StartsWith / EndsWith ----
			int StartsWith_Match()
			{
				return "HelloWorld".StartsWith("Hello") ? 1 : 0;
			}

			int StartsWith_NoMatch()
			{
				return "HelloWorld".StartsWith("World") ? 1 : 0;
			}

			int StartsWith_CaseSens()
			{
				return "Hello".StartsWith("hello", ESearchCase::CaseSensitive) ? 1 : 0;
			}

			int StartsWith_IgnCase()
			{
				return "Hello".StartsWith("hello", ESearchCase::IgnoreCase) ? 1 : 0;
			}
			...
			int EndsWith_Match()
			{
				return "HelloWorld".EndsWith("World") ? 1 : 0;
			}

			int EndsWith_NoMatch()
			{
				return "HelloWorld".EndsWith("Hello") ? 1 : 0;
			}

			int EndsWith_CaseSens()
			{
				return "World".EndsWith("world", ESearchCase::CaseSensitive) ? 1 : 0;
			}

			int EndsWith_IgnCase()
			{
				return "World".EndsWith("world", ESearchCase::IgnoreCase) ? 1 : 0;
			}

			// ---- MatchesWildcard ----
			int Wild_Star()
			{
				return "Hello.World".MatchesWildcard("Hello*") ? 1 : 0;
			}

			int Wild_Question()
			{
				return "ABC".MatchesWildcard("A?C") ? 1 : 0;
			}

			int Wild_NoMatch()
			{
				return "Hello".MatchesWildcard("Bye*") ? 1 : 0;
			}

			int Wild_Exact()
			{
				return "Hello".MatchesWildcard("Hello") ? 1 : 0;
			}

			// ---- Equals ----
			int Equals_CaseSensitive()
			{
				return "ABC".Equals("ABC", ESearchCase::CaseSensitive) ? 1 : 0;
			}

			int Equals_CaseSensDiff()
			{
				return "ABC".Equals("abc", ESearchCase::CaseSensitive) ? 1 : 0;
			}

			int Equals_IgnoreCase()
			{
				return "ABC".Equals("abc", ESearchCase::IgnoreCase) ? 1 : 0;
			}

			int Equals_EmptyEmpty()
			{
				FString A;
				FString B;
	...
	TEST_METHOD(Mutation)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_Mutation"), ASTEST_AS(R"AS(
			// ---- Append / AppendChar ----
			int Append_Basic()
			{
				FString S = "Hello";
	...
	TEST_METHOD(MutationExtended)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_MutExt"), ASTEST_AS(R"AS(
			// ---- AppendInt ----
	...
	TEST_METHOD(CaseAndTrim)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_CaseTrim"), ASTEST_AS(R"AS(
			// ---- ToUpper / ToLower ----
			int ToUpper_Lower()
			{
				return ("hello".ToUpper() == "HELLO") ? 1 : 0;
			}

			int ToUpper_Mixed()
			{
				return ("Hello World".ToUpper() == "HELLO WORLD") ? 1 : 0;
			}

			int ToUpper_AlreadyUpper()
			{
				return ("ABC".ToUpper() == "ABC") ? 1 : 0;
			}

			int ToUpper_Empty()
			{
				FString S;
				return S.ToUpper().IsEmpty() ? 1 : 0;
			}

			int ToLower_Upper()
			{
				return ("HELLO".ToLower() == "hello") ? 1 : 0;
			}

			int ToLower_Mixed()
			{
				return ("Hello World".ToLower() == "hello world") ? 1 : 0;
			}

			int ToLower_AlreadyLower()
			{
				return ("abc".ToLower() == "abc") ? 1 : 0;
			}

			int ToLower_Digits()
			{
				return ("ABC123".ToLower() == "abc123") ? 1 : 0;
			}

			// ---- TrimStartAndEnd / TrimStart / TrimEnd ----
			int TrimBoth_Spaces()
			{
				return ("  AB  ".TrimStartAndEnd() == "AB") ? 1 : 0;
			}

			int TrimBoth_NoSpace()
			{
				return ("AB".TrimStartAndEnd() == "AB") ? 1 : 0;
			}

			int TrimBoth_AllSpace()
			{
				return ("   ".TrimStartAndEnd().IsEmpty()) ? 1 : 0;
			}

			int TrimBoth_Tabs()
			{
				FString S = "\t Hello \t";
				return (S.TrimStartAndEnd() == "Hello") ? 1 : 0;
			}

			int TrimStart_Basic()
			{
				return ("  AB".TrimStart() == "AB") ? 1 : 0;
			}

			int TrimStart_NoSpace()
			{
				return ("AB  ".TrimStart() == "AB  ") ? 1 : 0;
			}
	...
	TEST_METHOD(Split)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_Split"), ASTEST_AS(R"AS(
			// ---- Split ----
			int Split_Basic()
			{
	...
	TEST_METHOD(SplitExtended)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_SplitExt"), ASTEST_AS(R"AS(
			// ---- ParseIntoArrayLines ----
	...
	TEST_METHOD(Conversion)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_Conv"), ASTEST_AS(R"AS(
			// ---- ToBool ----
			int ToBool_True()
			{
				return "true".ToBool() ? 1 : 0;
			}
			...
			int ToBool_True_Yes()
			{
				return "yes".ToBool() ? 1 : 0;
			}

			int ToBool_False()
			{
				return "false".ToBool() ? 1 : 0;
			}

			int ToBool_False_Zero()
			{
				return "0".ToBool() ? 1 : 0;
			}
			...
			int ToBool_False_No()
			{
				return "no".ToBool() ? 1 : 0;
			}

			// ---- IsNumeric ----
			int IsNumeric_Digits()
			{
				return "12345".IsNumeric() ? 1 : 0;
			}

			int IsNumeric_Float()
			{
				return "3.14".IsNumeric() ? 1 : 0;
			}

			int IsNumeric_Negative()
			{
				return "-42".IsNumeric() ? 1 : 0;
			}

			int IsNumeric_Alpha()
			{
				return "abc".IsNumeric() ? 1 : 0;
			}

			int IsNumeric_Mixed()
			{
				return "12ab".IsNumeric() ? 1 : 0;
			}

			int IsNumeric_Empty()
			{
				FString S;
				return S.IsNumeric() ? 1 : 0;
			}
	...
	TEST_METHOD(TypeConcat)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_TypeConcat"), ASTEST_AS(R"AS(
			int Concat_Int()
			{
				FString S = "Value=" + 42;
	...
	TEST_METHOD(FormatString)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_Format"), ASTEST_AS(R"AS(
	...
	TEST_METHOD(Join)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_Join"), ASTEST_AS(R"AS(
			int Join_Basic()
			{
				TArray<FString> Arr;
				Arr.Add("A");
	...
	TEST_METHOD(StaticConstruction)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_StaticCtor"), ASTEST_AS(R"AS(
			// ---- FString::FromInt ----
	...
	TEST_METHOD(ApplyFormat)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_ApplyFmt"), ASTEST_AS(R"AS(
			// ==== int32 ====
			int ApplyFmt_Int_Default()
			{
				return FString::ApplyFormat(42, "").Contains("42") ? 1 : 0;
			}

			int ApplyFmt_Int_Negative()
			{
				return FString::ApplyFormat(-10, "").Contains("-10") ? 1 : 0;
			}

			int ApplyFmt_Int_Zero()
			{
				return FString::ApplyFormat(0, "").Contains("0") ? 1 : 0;
			}

			int ApplyFmt_Int_Hex()
			{
				return FString::ApplyFormat(255, "x").ToLower().Contains("ff") ? 1 : 0;
			}

			int ApplyFmt_Int_HexUpper()
			{
				return FString::ApplyFormat(255, "X").Contains("FF") ? 1 : 0;
			}

			int ApplyFmt_Int_Octal()
			{
				return FString::ApplyFormat(8, "o").Contains("10") ? 1 : 0;
			}

			int ApplyFmt_Int_Binary()
			{
				return FString::ApplyFormat(5, "b").Contains("101") ? 1 : 0;
			}

			int ApplyFmt_Int_Char()
			{
				return FString::ApplyFormat(65, "c") == "A" ? 1 : 0;
			}

			int ApplyFmt_Int_Padded()
			{
				return FString::ApplyFormat(42, ">5").Len() >= 5 ? 1 : 0;
			}
			...
			// ==== float32 ====
			int ApplyFmt_Float_Default()
			{
				return FString::ApplyFormat(3.14f, "").Contains("3.14") ? 1 : 0;
			}

			int ApplyFmt_Float_Neg()
			{
				return FString::ApplyFormat(-2.5f, "").Contains("-2.5") ? 1 : 0;
			}

			int ApplyFmt_Float_Zero()
			{
				return FString::ApplyFormat(0.0f, "").Contains("0") ? 1 : 0;
			}
			...
			// ==== Bool ====
			int ApplyFmt_Bool_True()
			{
				return FString::ApplyFormat(true, "") == "true" ? 1 : 0;
			}

			int ApplyFmt_Bool_False()
			{
				return FString::ApplyFormat(false, "") == "false" ? 1 : 0;
			}
	...
	TEST_METHOD(Logging)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_Logging"), ASTEST_AS(R"AS(
			int Log_Compiles()
			{
	...
	TEST_METHOD(ReturnFString)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_RetStr"), ASTEST_AS(R"AS(
			FString Ret_Literal()
			{
				return "Hello World";
			}
	...
	TEST_METHOD(PassFString)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASFString_PassStr"), ASTEST_AS(R"AS(
			// Identity round-trip
