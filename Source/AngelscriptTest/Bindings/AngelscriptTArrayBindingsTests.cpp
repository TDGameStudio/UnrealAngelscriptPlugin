...
int Entry()
{
	...
	return Assert.AreEqual(1, Result, TEXT("TArray mutation helpers should match expected script behaviour"));
}
...
int Entry()
{
	...
	FNoDiscardAsserter Assert(Test);
	return Assert.AreEqual(1, Result, TEXT("TArray iterator helpers should match expected script behaviour"));
}
	...
	bPassed &= TArrayBindingsExecuteFunctionReturningScriptArray(
		...
		*Module,
		...
		[&Test](const FScriptArray& ReturnedArray)
		{
			...
			return Assert.AreEqual(3, ReturnedArray.Num(), TEXT("Returned TArray<int> should have Num=3"))
				&& Assert.IsNotNull(Values, TEXT("Returned TArray<int> should expose data"))
				&& Assert.AreEqual(3, Values[0], TEXT("Returned TArray<int>[0]"))
				&& Assert.AreEqual(5, Values[1], TEXT("Returned TArray<int>[1]"))
				&& Assert.AreEqual(8, Values[2], TEXT("Returned TArray<int>[2]"));
		});
	bPassed &= TArrayBindingsExecuteFunctionReturningScriptArray(
		Test,
		Engine,
		*Module,
		...
		[&Test](const FScriptArray& ReturnedArray)
		{
			...
			return Assert.AreEqual(2, ReturnedArray.Num(), TEXT("Returned TArray<FVector> should have Num=2"))
				&& Assert.IsNotNull(Values, TEXT("Returned TArray<FVector> should expose data"))
				&& Assert.AreEqual(FVector(1.0, 2.0, 3.0), Values[0], TEXT("Returned TArray<FVector>[0]"))
				&& Assert.AreEqual(FVector(4.0, 5.0, 6.0), Values[1], TEXT("Returned TArray<FVector>[1]"));
		});
	bPassed &= TArrayBindingsExecuteFunctionReturningScriptArray(
		Test,
		Engine,
		*Module,
		...
		[&Test](const FScriptArray& ReturnedArray)
		{
			...
			return Assert.AreEqual(2, ReturnedArray.Num(), TEXT("Returned TArray<UObject> should have Num=2"))
				&& Assert.IsNotNull(Objects, TEXT("Returned TArray<UObject> should expose data"))
				&& Assert.AreEqual(ExpectedDefaultObject, Objects[0], TEXT("Returned TArray<UObject>[0]"))
				&& Assert.IsNull(Objects[1], TEXT("Returned TArray<UObject>[1] should be null"));
		});
	bPassed &= TArrayBindingsExecuteFunctionReturningScriptArray(
		Test,
		Engine,
		*Module,
		...
		[&Test](const FScriptArray& ReturnedArray)
		{
			...
			return Assert.AreEqual(2, ReturnedArray.Num(), TEXT("Returned TArray<AActor> should have Num=2"))
				&& Assert.IsNotNull(Actors, TEXT("Returned TArray<AActor> should expose data"))
				&& Assert.AreEqual(ExpectedDefaultActor, Actors[0], TEXT("Returned TArray<AActor>[0]"))
				&& Assert.IsNull(Actors[1], TEXT("Returned TArray<AActor>[1] should be null"));
		});
	bPassed &= TArrayBindingsExecuteFunctionReturningScriptArray(
		Test,
		Engine,
		*Module,
		...
		[&Test](const FScriptArray& ReturnedArray)
		{
			...
			return Assert.AreEqual(2, ReturnedArray.Num(), TEXT("Returned TArray<TSubclassOf<AActor>> should have Num=2"))
				&& Assert.IsNotNull(Classes, TEXT("Returned TArray<TSubclassOf<AActor>> should expose data"))
				&& Assert.AreEqual(AActor::StaticClass(), Classes[0].Get(), TEXT("Returned TArray<TSubclassOf<AActor>>[0]"))
				&& Assert.AreEqual(ACameraActor::StaticClass(), Classes[1].Get(), TEXT("Returned TArray<TSubclassOf<AActor>>[1]"));
		});
