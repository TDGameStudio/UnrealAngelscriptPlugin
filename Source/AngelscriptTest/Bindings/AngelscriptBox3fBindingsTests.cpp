	...
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
{
	...
	TEST_METHOD(FBoxConstruction)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASBox3f_FBoxCtor"), ASTEST_AS(R"AS(
	...
	TEST_METHOD(FBox3fConstruction)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASBox3f_FBox3fCtor"), ASTEST_AS(R"AS(
	...
	TEST_METHOD(FBoxSphereBoundsConstruction)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASBox3f_BSBCtor"), ASTEST_AS(R"AS(
			int BSB_Origin()
			{
	...
	TEST_METHOD(FBoxSphereBounds3fConstruction)
	{
		...
		FScopedAngelscriptModule Mod(*TestRunner, Engine, TEXT("ASBox3f_BSB3fCtor"), ASTEST_AS(R"AS(
			int BSB3f_Origin()
			{
