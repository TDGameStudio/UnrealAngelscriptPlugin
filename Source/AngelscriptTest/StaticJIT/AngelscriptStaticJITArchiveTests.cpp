...
namespace AngelscriptTest_StaticJIT_AngelscriptStaticJITArchiveTests_Private
{

bool RunStringInArchiveRoundtripUtf8(FAutomationTestBase& Test)
{
	...
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
{
	...
	{
		using namespace AngelscriptTest_StaticJIT_AngelscriptStaticJITArchiveTests_Private;
