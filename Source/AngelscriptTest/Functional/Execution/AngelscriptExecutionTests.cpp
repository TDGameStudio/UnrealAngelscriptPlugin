...
{
private:
static bool RunBasic(FAutomationTestBase& Test)
{
...
static bool RunOneArg(FAutomationTestBase& Test)
{
FAngelscriptEngine& Engine = ASTEST_CREATE_ENGINE();
{ FAngelscriptEngineScope _AutoEngineScope(Engine);
...
static bool RunTwoArgs(FAutomationTestBase& Test)
{
FAngelscriptEngine& Engine = ASTEST_CREATE_ENGINE();
{ FAngelscriptEngineScope _AutoEngineScope(Engine);
...
static bool RunFourArgs(FAutomationTestBase& Test)
{
FAngelscriptEngine& Engine = ASTEST_CREATE_ENGINE();
{ FAngelscriptEngineScope _AutoEngineScope(Engine);
...
static bool RunMixedArgs(FAutomationTestBase& Test)
{
FAngelscriptEngine& Engine = ASTEST_CREATE_ENGINE();
{ FAngelscriptEngineScope _AutoEngineScope(Engine);
...
static bool RunInt64QWordRoundTrip(FAutomationTestBase& Test)
{
FAngelscriptEngine& Engine = ASTEST_CREATE_ENGINE();
{ FAngelscriptEngineScope _AutoEngineScope(Engine);
...
static bool RunContext(FAutomationTestBase& Test)
{
FAngelscriptEngine& Engine = ASTEST_CREATE_ENGINE();
{ FAngelscriptEngineScope _AutoEngineScope(Engine);
...
static bool RunNested(FAutomationTestBase& Test)
{
FAngelscriptEngine& Engine = ASTEST_CREATE_ENGINE();
{ FAngelscriptEngineScope _AutoEngineScope(Engine);
...
static bool RunDiscard(FAutomationTestBase& Test)
{
FAngelscriptEngine& Engine = ASTEST_CREATE_ENGINE();
{ FAngelscriptEngineScope _AutoEngineScope(Engine);
...
static bool RunScript(FAutomationTestBase& Test)
{
FAngelscriptEngine& Engine = ASTEST_CREATE_ENGINE();
{ FAngelscriptEngineScope _AutoEngineScope(Engine);
...
public:
	TEST_METHOD(Basic)
	{
		ASSERT_THAT(IsTrue(RunBasic(*TestRunner)));
	}

	TEST_METHOD(OneArg)
	{
		ASSERT_THAT(IsTrue(RunOneArg(*TestRunner)));
	}

	TEST_METHOD(TwoArgs)
	{
		ASSERT_THAT(IsTrue(RunTwoArgs(*TestRunner)));
	}

	TEST_METHOD(FourArgs)
	{
		ASSERT_THAT(IsTrue(RunFourArgs(*TestRunner)));
	}

	TEST_METHOD(MixedArgs)
	{
		ASSERT_THAT(IsTrue(RunMixedArgs(*TestRunner)));
	}

	TEST_METHOD(Int64QWordRoundTrip)
	{
		ASSERT_THAT(IsTrue(RunInt64QWordRoundTrip(*TestRunner)));
	}

	TEST_METHOD(Context)
	{
		ASSERT_THAT(IsTrue(RunContext(*TestRunner)));
	}

	TEST_METHOD(Nested)
	{
		ASSERT_THAT(IsTrue(RunNested(*TestRunner)));
	}

	TEST_METHOD(Discard)
	{
		ASSERT_THAT(IsTrue(RunDiscard(*TestRunner)));
	}

	TEST_METHOD(Script)
	{
		ASSERT_THAT(IsTrue(RunScript(*TestRunner)));
	}
};
