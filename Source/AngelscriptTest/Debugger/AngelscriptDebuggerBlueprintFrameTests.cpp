...
inline static const FName BlueprintInvocationFunctionName = FName(TEXT("CallIntoScript"));
inline static const FName ScriptBreakpointFunctionName = FName(TEXT("BreakInScript"));
inline static const FName ScriptValuePropertyName = FName(TEXT("ScriptValue"));
inline static const FName LastBreakResultPropertyName = FName(TEXT("LastBreakResult"));

static bool WaitForVoidInvocationCompletion(
...
static bool CreateTransientBlueprintCallingScriptFunction(
	FAutomationTestBase& Test,
	UClass& ParentClass,
...
static int32 FindCallstackFrameIndexByPrefix(const FAngelscriptCallStack& Callstack, const FString& Prefix)
{
...
static TFuture<FBlueprintFrameMonitorResult> StartBlueprintFrameMonitor(
	int32 Port,
