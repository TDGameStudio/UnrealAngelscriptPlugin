...
TEST_CLASS_WITH_FLAGS(FContextRecoveryTests,
	"Angelscript.TestModule.AngelScriptSDK.Runtime.ContextRecovery",
...
public:
	TEST_METHOD(ContextCanBeReusedAfterDeepStackException)
	{
		...
		asIScriptFunction* SafeFunction = AngelscriptNativeTestSupport::GetNativeFunctionByDecl(Module, "int Safe(const int)");
	...
	TEST_METHOD(ContextCanSwitchSignaturesAfterException)
	{
		...
		asIScriptFunction* OneArgFunction = AngelscriptNativeTestSupport::GetNativeFunctionByDecl(Module, "int OneArg(const int)");
