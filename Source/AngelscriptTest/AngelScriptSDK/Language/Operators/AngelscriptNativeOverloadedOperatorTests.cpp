...
TEST_CLASS_WITH_FLAGS(FOverloadedOperatorTests,
...
public:
	TEST_METHOD(IntegerResultsByScenarioAndConsumer)
	{
		using namespace AngelscriptNativeTestSupport;
		AS_NATIVE_PRODUCT("LANG-OP-OVERLOAD-INTEGER-CONSUMER",
		...
		RunResultScenarios(
			...
			EResultKind::Integer,
			IntegerScenarioSourceCount,
			TEXT("integer-result overload product"));
	}
};
