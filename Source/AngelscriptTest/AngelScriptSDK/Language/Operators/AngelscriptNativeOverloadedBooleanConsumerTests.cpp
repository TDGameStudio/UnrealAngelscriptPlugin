...
TEST_CLASS_WITH_FLAGS(FOverloadedBooleanConsumerTests,
...
public:
	...
	TEST_METHOD(BooleanResultsByScenarioAndConsumer)
	{
		using namespace AngelscriptNativeTestSupport;
		AS_NATIVE_PRODUCT("LANG-OP-OVERLOAD-BOOLEAN-CONSUMER",
		...
		RunResultScenarios(
			...
			EResultKind::Boolean,
			BooleanScenarioSourceCount,
			TEXT("boolean-result overload product"));
	}
};
