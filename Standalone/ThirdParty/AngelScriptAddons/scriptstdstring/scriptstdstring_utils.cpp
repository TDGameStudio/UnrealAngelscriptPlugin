...
{
	// Get the arguments
	// The maintained fork models registered implicit-handle reference types as
	// references to the handle slot. Dereference both the generic argument
	// reference and that slot to reach the array object.
