...
typedef AS_NAMESPACE_QUALIFIER scriptstring_t dictKey_t;
...
typedef std::unordered_map<
	dictKey_t,
	AS_NAMESPACE_QUALIFIER CScriptDictValue,
	AS_NAMESPACE_QUALIFIER FScriptStringHash,
	std::equal_to<dictKey_t>,
	AS_NAMESPACE_QUALIFIER TScriptStdAllocator<
		std::pair<const dictKey_t, AS_NAMESPACE_QUALIFIER CScriptDictValue>>> dictMap_t;
#else
#include <map>
typedef std::map<
	dictKey_t,
